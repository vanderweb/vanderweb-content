...
class Vanderweb_Bs4_Accordion {
	...
	private function define_admin_hooks() {
		...
		// Add post_type and taxonomy
		$plugin_post_types = new Vanderweb_Accordion_Post_Types();
		$this->loader->add_action( 'init', $plugin_post_types, 'vw_accordion_post_types', 999 );
		$this->loader->add_action( 'init', $plugin_post_types, 'create_vw_accordion_taxonomy', 999 );
	...
	private function define_public_hooks() {
		 ...
		 */
		$this->loader->add_shortcode( "vanderweb_accordions", $plugin_public, "vanderweb_accordions_func", $priority = 10, $accepted_args = 2 );
		$this->loader->add_shortcode( "vanderweb_tabs", $plugin_public, "vanderweb_tabs_func", $priority = 10, $accepted_args = 2 );
